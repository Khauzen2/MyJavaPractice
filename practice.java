...
public class practice {
    public static void main(String[] args) {
        ...
        // days of the week input output
        System.out.println("Enter first day of the week");
        daysOfWeek[0] = input.nextLine();
        System.out.println("Enter second day of the week");
        daysOfWeek[1] = input.nextLine();
        System.out.println("Enter third day of the week");
        daysOfWeek[2] = input.nextLine();
        System.out.println("Enter fourth day of the week");
        daysOfWeek[3] = input.nextLine();
        System.out.println("Enter fith day of the week");
        daysOfWeek[4] = input.nextLine();
        System.out.println("Enter sixth day of the week");
        daysOfWeek[5] = input.nextLine();
        System.out.println("Enter seventh day of the week");
        daysOfWeek[6] = input.nextLine();
        ...
        System.out.println("The third day of the week is " + daysOfWeek[2]);
        System.out.println("The fourth day of the week is " + daysOfWeek[3]);
        System.out.println("The fith day of the week is " + daysOfWeek[4]);
        System.out.println("The sixth day of the week is " + daysOfWeek[5]);
        System.out.println("The seventh day of the week is " + daysOfWeek[6]);

        // months input output
        System.out.println("Enter first month");
        months[0] = input.nextLine();
        System.out.println("Enter second month");
        months[1] = input.nextLine();
        System.out.println("Enter third month");
        months[2] = input.nextLine();
        System.out.println("Enter fourth month");
        months[3] = input.nextLine();
        System.out.println("Enter fith month");
        months[4] = input.nextLine();
        System.out.println("Enter sixth month");
        months[5] = input.nextLine();
        System.out.println("Enter seventh month");
        months[6] = input.nextLine();
        System.out.println("Enter eighth month");
        months[7] = input.nextLine();
        System.out.println("Enter nineth month");
        months[8] = input.nextLine();
        System.out.println("Enter tenth month");
        months[9] = input.nextLine();
        System.out.println("Enter eleventh month");
        months[10] = input.nextLine();
        System.out.println("Enter twenth month");
        months[11] = input.nextLine();

        // output
        System.out.println("The first month is " + months[0]);
        System.out.println("The second month is " + months[1]);
        System.out.println("The third month is " + months[2]);
        System.out.println("The fourth month is " + months[3]);
        System.out.println("The fifth month is " + months[4]);
        System.out.println("The sixth month is " + months[5]);
        System.out.println("The seventh month is " + months[6]);
        System.out.println("The eighth month is " + months[7]);
        System.out.println("The nineth month is " + months[8]);
